...
const Card = ({ obj }) => {
    ...
    return (
        <section className="flex justify-center items-center gap-5 bg-slate-100 border shadow-md p-5 rounded-lg">
            <div className="avatar">
                <div className="w-20 rounded-full ring ring-pink-600 ring-offset-base-100 ring-offset-2">
