            ...
            <AwesomeSlider>
                <div className="bg-[url('https://i.ibb.co/qkCkRDW/nordwood-themes-F3-Dde-9thd8-unsplash.jpg')] bg-cover w-full h-full">
                    <div className=' w-[90%] lg:w-[40%] lg:mt-64 mx-auto mt-16 lg:ml-28'>
                        <h1 className='text-emerald-500 font-semibold lg:text-6xl text-4xl'>learn something new with us</h1>
                ...
                <div className="bg-[url('https://i.ibb.co/mzMmZGM/theregisti-HSXIp58y-Py-I-unsplash.jpg')] bg-cover w-full h-full">
                    <div className='lg:w-[50%] w-[90%] text-center mt-12 lg:mt-72 mx-auto'>
                        <h1 className='text-cyan-300 font-semibold lg:text-6xl text-4xl'>prove on your selfe that you are geniuse</h1>
                ...
                <div className="bg-[url('https://i.ibb.co/dr05kC1/robert-shunev-m-S1nl-Ybq1k-A-unsplash.jpg')] bg-cover w-full h-full">
                    <div className='lg:w-[40%] w-[90%]  mt-24 mx-auto text-center'>
                        <h1 className='text-emerald-500 font-semibold lg:text-6xl text-4xl'>learn with us hobby</h1>
